...
const QuizTopicsScreen: React.FC = () => {
  ...
  return (
    <PageCenter light justifyCenter>
      <CenterCardContainer>
        <Heading>
          ДОБРО ПОЖАЛОВАТЬ НА <HighlightedText> КВИЗ СГУГИТ</HighlightedText>
        </Heading>
        <DetailText>Выберите тему для старта квиза.</DetailText>
        ...
        <Button text="Продолжить" onClick={goToQuizDetailsScreen} bold />
      </CenterCardContainer>
    </PageCenter>
  )
}
